...
const FeaturedGames = () => {
  ...
  return (
    <section id="games" className="py-20 px-4 bg-gaming-light relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto relative z-10">
          ...
          {featuredGames.map((game, index) => (
            ...
            >
              <CardContent className="p-0">
                ...
                <div className="relative overflow-hidden rounded-t-2xl">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-gaming-text/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="absolute bottom-4 left-4 right-4">
                      <button className="w-full bg-gaming-accent hover:bg-gaming-accent-hover text-gaming-light font-semibold py-2 px-4 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-gaming">
                  ...
                  <div className="absolute top-4 left-4 flex space-x-2">
                    {game.isNew && (
                      <span className="bg-gaming-accent text-gaming-light text-xs font-bold px-3 py-1 rounded-full shadow-gaming">
                        NEW
                      </span>
                    )}
                    {game.isPopular && (
                      <span className="bg-red-500 text-white text-xs font-bold px-3 py-1 rounded-full shadow-gaming">
                        POPULAR
                      </span>
                    )}
                  </div>
                  ...
                  {/* Rating */}
                  <div className="absolute top-4 right-4 flex items-center space-x-1 bg-gaming-light/90 backdrop-blur-sm px-3 py-1 rounded-full shadow-gaming">
                ...
                <div className="p-6">
                  <div className="mb-3">
                    <h3 className="font-bold text-lg text-gaming-text group-hover:text-gaming-accent transition-colors duration-200">
                      {game.title}
                    </h3>
        ...
        <div className="text-center mt-12">
          <button className="bg-gaming-accent hover:bg-gaming-accent-hover text-gaming-light font-semibold px-8 py-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-gaming-lg">
